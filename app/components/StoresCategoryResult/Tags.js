    ...
    return (
      ...
      <View style={styles.container}>
        <View style={[styles.box, styles.boxfirst]}>
          <TouchableOpacity>
            <Text style={styles.heading}><AntDesign name="inbox" style={{color: '#9fc8d3', fontSize: 30,}} /> 144</Text>
            <Text style={styles.pera}> Products Found</Text>
          </TouchableOpacity>
        </View>
        <View style={[styles.box, styles.boxsecond, styles.active]}>
          <TouchableOpacity>
            <Text style={styles.heading}><Entypo name="shop" style={{color: '#fff', fontSize: 30,}} /> 12</Text>
