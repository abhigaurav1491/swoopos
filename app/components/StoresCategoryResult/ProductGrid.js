      ...
      <View style={styles.container}>
        <View style={styles.row}>
          <View style={styles.box}>
            ...
            <Image style={styles.image} source={require('../../assets/images/store1.jpg')} />
            <View style={styles.contentbox}>
              <View style={styles.topbox}>
                <Text style={styles.lefttxt}>£ 144.00</Text>
                <Text style={styles.righttxt}> £ 57.6 </Text>
              </View>
              <Text style={styles.nameheading}>Peri Peri Grill</Text>
              ...
              <Text style={styles.pera}>Russell Hobbs RHM2076B 20L Digital 800w Solo Microwave Black</Text>
          ...
          <View style={styles.box}>
            ...
            <Image style={styles.image} source={require('../../assets/images/store2.jpg')} />
            <View style={styles.contentbox}>
              <View style={styles.topbox}>
                <Text style={styles.lefttxt}>£ 144.00</Text>
                <Text style={styles.righttxt}> £ 57.6 </Text>
              </View>
              <Text style={styles.nameheading}>Hasty Tasty Pizza</Text>
              <View style={styles.ratingwp}>
                <StarRating fullStarColor={'#ed8a19'}
                  emptyStarColor= {'#ed8a19'}
                  starSize= {16}
