      ...
      <View style={styles.container}>
        ...
        <View style={styles.row}>
          <View style={styles.box}>
            ...
            <Image style={styles.image} source={require('../../assets/images/product3.jpg')} />
            <View style={styles.contentbox}>
              <View style={styles.topbox}>
                <Text style={styles.lefttxt}>£ 144.00</Text>
                <Text style={styles.righttxt}> £ 57.6 </Text>
          ...
          <View style={styles.box}>
            ...
            <Image style={styles.image} source={require('../../assets/images/product4.jpg')} />
            <View style={styles.contentbox}>
              <View style={styles.topbox}>
                <Text style={styles.lefttxt}>£ 144.00</Text>
                <Text style={styles.righttxt}> £ 57.6 </Text>
...
const styles = StyleSheet.create({
  ...
  nameheading: {fontSize: 24, color: '#fff', fontWeight: 'bold'},
